...
function ex01() {
  let ex01_num01 = parseInt(document.getElementById("ex01_num01").value)
  let ex01_num02 = parseInt(document.getElementById("ex01_num02").value)
  let ex01_num03 = parseInt(document.getElementById("ex01_num03").value)
  let ex01_result = document.getElementById("ex01_result")
  let min = Math.min(ex01_num01, ex01_num02, ex01_num03)
  let max = Math.max(ex01_num01, ex01_num02, ex01_num03)
  let mid = 0
  if (ex01_num01 !== min && ex01_num01 !== max) {
    mid = ex01_num01
  } else if (ex01_num02 !== min && ex01_num02 !== max) {
    mid = ex01_num02
  } else mid = ex01_num03
  ex01_result.classList.add("alert")
  ex01_result.innerHTML = `Thứ tự tăng dần: ${min} - ${mid} - ${max}`
}
